      ...
      <ul class="w-full">
        <li @click="goTo('orders')" class="relative flex items-center justify-between py-2.5 border-b px-3 hover:bg-gray-100 cursor-pointer">
          <div class="flex items-center text-[18px] font-semibold">
            <Icon name="ph:pen-light" size="30" />
            <span class="pl-4">My Orders</span>
          </div>
        </li>
        <li @click="goTo('shopping-cart')" class="relative flex items-center justify-between py-2.5 border-b px-3 hover:bg-gray-100 cursor-pointer">
          <div class="flex items-center text-[18px] font-semibold">
            <Icon name="ph:shopping-cart-simple-light" size="30" />
            <span class="pl-4">Cart</span>
          </div>
          <div class="flex items-center justify-center bg-[#ff4646] h-[35px] w-[35px] text-lg text-white rounded-full">{{ userStore.cart.length }}</div>
        </li>
        <li v-if="false" @click="signOut()" class="relative flex items-center justify-between py-2.5 border-b px-3 hover:bg-gray-100 cursor-pointer">
          <div class="flex items-center text-[18px] font-semibold">
            <Icon name="ph:sign-out-light" size="30" />
        ...
        <li v-else @click="signIn()" class="relative flex items-center justify-between py-2.5 border-b px-3 hover:bg-gray-100 cursor-pointer">
          <div class="flex items-center text-[18px] font-semibold">
            <Icon name="ph:sign-in-light" size="30" />
